...
class _HttpDemoHomeState extends State<HttpDemoHome> {
  ...
  Future<List<Post>> fetchPost() async{
    final response = await http.get('http://resources.ninghao.net/demo/posts.json');
...
class Post{
  ...
  Post.fromJson(Map json):id=json['id'],title = json['title'],description = json['description'],author = json['author'],imageUrl = json['imageUrl'];
